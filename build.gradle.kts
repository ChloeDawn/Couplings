...
plugins {
  id(/*net.fabricmc.*/ "fabric-loom") version "1.2.7"
...
dependencies {
  ...
  modImplementation(include(fabricApi.module("fabric-api-base", "0.80.0+1.19.4"))!!)
  modImplementation(include(fabricApi.module("fabric-networking-api-v1", "0.80.0+1.19.4"))!!)
